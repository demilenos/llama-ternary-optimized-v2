...
## 2026-09-20: scoped A750 PTQ1 CM1 serialization

Global serialization was not required for decode. Restricting the A750 PTQ1 CM1 workaround to MUL_MAT graphs with N>8 preserved PP XMX throughput while restoring normal asynchronous scheduling for N<=8 decode. Under matched Q8-KV conditions, TG128 was unchanged (13.9447 vs 13.9352 tok/s), while PP512 improved from 77.9687 to 127.1916 tok/s. XMX without scoped serialization timed out during PP512.
